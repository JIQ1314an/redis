package cn.edu.zut.redis.common.serice;
...
public class BaseRedisService<T> {
     ...
     * 针对字符串类型的数据追加
     * @param key 键
     * @param append 改键对应的值要追加的字符串
     * @return 返回最终该值的长度
     */
    public int append(String key,String append) {
        return redisTemplate.opsForValue().append(key,append);
    }
     ...
     *
     * @param listKey
     * @param duration 有效期时间
     * @param values   待添加的数据
     */
    public void addToListRight(String listKey, long duration, T... values) {
        //绑定操作
        BoundListOperations<String, T> boundValueOperations = redisTemplate.boundListOps(listKey);
        //插入数据
        boundValueOperations.rightPushAll(values);
        //设置过期时间
        boundValueOperations.expire(Duration.ofSeconds(duration));
    }
     ...
     * @return
     */
    public List<T> rangeList(String listKey, long start, long end) {
        //绑定操作
        BoundListOperations<String, T> boundValueOperations = redisTemplate.boundListOps(listKey);
        //查询数据
     ...
     * @param listKey
     */
    public T rifhtPop(String listKey) {
        //绑定操作
        BoundListOperations<String, T> boundValueOperations = redisTemplate.boundListOps(listKey);
